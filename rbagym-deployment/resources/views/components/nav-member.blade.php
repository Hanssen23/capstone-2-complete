<aside class="sidebar bg-white" id="sidebar">
    <div class="flex flex-col items-center h-full p-5">
            ...
            <div class="flex items-center justify-start gap-2">
                ...
                <div>
                    ...
                    <div class="text-xs font-medium" style="color: #6B7280;">
                        {{ strtoupper(auth()->guard('member')->user()->full_name ?? auth()->guard('member')->user()->first_name ?? 'UNKNOWN') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav class="w-full flex flex-col gap-2 flex-grow mt-1">
            <x-nav-item src="images/icons/dashboard-icon.svg" href="/member">Dashboard</x-nav-item>
            
            <x-nav-item src="images/icons/clipboard-icon.svg" href="/member/plans">Membership Plans</x-nav-item>
            
            <!-- Separator -->
            <hr class="border border-gray-300 w-full my-2">
            
            <x-nav-item src="images/icons/accounts-icon.svg" href="/member/accounts">Accounts</x-nav-item>
        </nav>
