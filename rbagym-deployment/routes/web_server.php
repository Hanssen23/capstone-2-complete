...
Route::prefix('rfid')->group(function () {
    Route::post('tap', [RfidController::class, 'handleCardTap'])->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class, \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class]);
    Route::get('active-members-public', [RfidController::class, 'getActiveMembers'])->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class, \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class]);
    Route::get('logs-public', [RfidController::class, 'getRfidLogs'])->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class, \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class]);
});

// RFID routes (protected by auth)
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('membership')->name('membership.')->group(function () {
        ...
        Route::get('payments/preview/csv', [MembershipController::class, 'previewCsv'])->name('payments.preview_csv');
