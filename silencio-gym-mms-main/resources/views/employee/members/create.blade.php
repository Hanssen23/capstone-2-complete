        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="mb-4 sm:mb-6 -mx-4 sm:-mx-6 px-4 sm:px-6 py-3 bg-white border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    <a href="{{ route('employee.members.index') }}" class="flex items-center gap-2 text-black hover:text-red-600 transition-colors duration-200 min-h-[44px]">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-black p-4 sm:p-6">
                ...
                @endif
                <form method="POST" action="{{ route('employee.members.store') }}" class="space-y-4 sm:space-y-6">
                    @csrf
