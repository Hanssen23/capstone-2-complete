...
Route::middleware(['auth'])->group(function () {
    // Member Routes (shared between admin and employee)
    ...
    // Membership Management Routes (shared between admin and employee)
    ...
    // Membership Plans API Routes (shared between admin and employee)
    ...
    // Account Management Routes (shared between admin and employee)
...
Route::middleware(['auth', 'admin.only'])->group(function () {
    ...
    Route::prefix('auto-deletion')->name('auto-deletion.')->group(function () {
...
// Employee Routes - Protected with employee.only middleware
